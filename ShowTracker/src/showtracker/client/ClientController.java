...
public class ClientController extends JFrame {
	...
	public void startApplication() {
		...
		ImageIcon myListImage = new ImageIcon("images/list.png");
		Image myListImg = myListImage.getImage().getScaledInstance(50, 50, Image.SCALE_SMOOTH);
		ImageIcon myListImgIcon = new ImageIcon(myListImg);
		...
		ImageIcon searchImageIcon = new ImageIcon(searchImg);
		...
		ImageIcon exitImageIcon = new ImageIcon(exitImg);


		JButton button1 = new JButton(profileImgIcon);
		JButton button2 = new JButton(myListImgIcon);
		JButton button3 = new JButton(homeImgIcon);
		JButton button4 = new JButton(searchImageIcon);
		JButton button5 = new JButton(exitImageIcon);
